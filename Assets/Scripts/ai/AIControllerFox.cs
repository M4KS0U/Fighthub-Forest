...
public class AIControllerFox : MonoBehaviour
{
    ...
    private bool IsEnemyInRange()
    {
        ...
        return Vector3.Distance(transform.position, closestEnemy.position) < 5f;
    }

    private void GoTo()
    {
        Transform closestEnemy = FindClosestEnemy();
        Vector3 runTo = transform.position - closestEnemy.position;
        runTo.Normalize();
        runTo *= 10f;
